<?php
// Vercel entry point and front controller for Bushloe Healthcare Centre
...
// Build file path relative to this file inside api/
$page_file = dirname(__DIR__) . '/pages/' . $page . '.php';
