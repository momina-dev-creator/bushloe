<?php
// submit.php - Handles form submissions for Bushloe Healthcare Centre
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        // In local environments, mail might not be configured, so we also write to a local log file for testing
